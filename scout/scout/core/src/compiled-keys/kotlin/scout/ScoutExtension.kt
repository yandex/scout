...
import scout.mapper.CompiledKeyMapper
...
inline fun Scout.enableKeyDecoding() {
    compiledKeyMapper = object : CompiledKeyMapper {
        override fun __init_mapping__(map: KeysMap) {
            // Method implements by gradle plugin
        }
    }
}

@PublishedApi
internal var compiledKeyMapper: CompiledKeyMapper? = null
